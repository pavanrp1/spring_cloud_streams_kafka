...
public class Opennms3Application {
 
	private static Logger logger = LoggerFactory.getLogger(Opennms3Application.class);
 
	public static void main(String[] args) {
		SpringApplication.run(Opennms3Application.class, args);
	}
